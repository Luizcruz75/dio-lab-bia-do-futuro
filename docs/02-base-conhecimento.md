...
| `perfil_investidor.json` | JSON | Personalizar as explicações sobre as dúvidas e encessidades de aprendizado do cliente. |
...
O exemplo de contexto montado abaixo, se baseia nos dados originais de base de conhecimento, mas os sintetiza deixando apenas as informações mais relevantes, otimizando assim o consumo de tokens. Entretanto, valçe lembrar que mais importante do que 
economizar tokens é terr todas as informações relevantes disponíveis em seu contexto.
